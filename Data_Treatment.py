...
Vis_DNSB_Val = pd.read_csv(r'C:\Users\storc\OneDrive\Thesis Work\Data\Visible_DNSB_Values(300).csv')
Vis_DNSB_Dat = pd.read_csv(r'C:\Users\storc\OneDrive\Thesis Work\Data\Visible_DNSB_Data(300).csv')
#Fin are final positions R and z
Vis_DNSB_Fin = pd.read_csv(r'C:\Users\storc\OneDrive\Thesis Work\Data\Final_Position(300).csv')
#length of the list
...
for i in range(0, List_len):
    if(Vis_DNSB_Fin.at[i, 'Final Position (R)'] < 0):
        drop_list1.append(i)
    elif(np.sqrt(np.square(Vis_DNSB_Fin.at[i, 'Final Position (R)']) + np.square(Vis_DNSB_Fin.at[i, 'Final Position (z)'])) > 778):
        drop_list1.append(i)
...
# =============================================================================
# Vis_DNSB_Fin.to_csv (r'C:\Users\storc\Desktop\Final_Position(300_2_Andromeda).csv', 
#                   index = False, header=True)
# Vis_DNSB_Dat.to_csv (r'C:\Users\storc\Desktop\Visible_DNSB_Data(300_2_Andromeda).csv', 
#                   index = False, header=True)
# Vis_DNSB_Val.to_csv (r'C:\Users\storc\Desktop\Visible_DNSB_Values(300_2_Andromeda).csv', 
#                   index = False, header=True)
# =============================================================================
